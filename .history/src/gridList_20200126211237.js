...
class GridList extends Component {
  render() {
    ...
    if(seacrhedData.length>0){
      seacrhedData.forEach(item=>{
    ...
    const title=(seacrhedData[0].ccy + ' Invoices with value between ' + seacrhedData[0].lowerLimit +' - '+ seacrhedData[0].upperLimit +' maturing between '+seacrhedData[0].startDate+' and '+ seacrhedData[0].endDate)
