...
class SearchBar extends Component {
  ...
  render() {
    ...
    const sectionGrid={ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', marginBottom: '2em' }
    const sectionLabel = { fontSize: '1.3em', fontWeight: 'bold', marginBottom: '-1em' }
    const sectionDateLabel = { fontSize: '1.3em', fontWeight: 'bold', marginBottom: '-.2em' }
            ...
            <Grid style={sectionGrid}>
              ...
              <Grid style={innerSection}>
                <FormControl style={formControlStyle} >
                  ...
                  <Input type='number' value={lowerLimit}onChange={this.setLowerLimit}/>
                </FormControl>
                <FormControl style={formControlStyleLeft} >
                  <InputLabel id="ccy">
                    Amount Below
                  </InputLabel>
                  <Input type='number' value={upperLimit} onChange={this.setUpperLimit} />
                </FormControl>
              </Grid>
            </Grid>
