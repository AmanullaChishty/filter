...
import { Grid, Card, CardContent,CardActions, Input } from '@material-ui/core';
...
class SearchBar extends Component {
  ...
  render() {
    ...
    <Card style={{maxWidth:675,width:'100%'}}>
      <CardContent>
        <Grid style={{display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column',marginBottom:'1em'}}>
