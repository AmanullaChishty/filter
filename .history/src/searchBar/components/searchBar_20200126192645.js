...
class SearchBar extends Component {
  ...
  setEndDate(event){
    ...
    let dd=date.getDate();
    let val = dd+'/'+ mm +'/'+yyyy;
    console.log('date ',new Date(event).getTime() / 1000)
    console.log('date 123',Math.floor(event.getTime()/1000))
    ...
    return (
      <Grid style={{display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column'}}>
        {/* <input
         ...
         />
    <h3>{value}</h3> */}
    <Card style={{maxWidth:675,width:'100%',padding:'2em',margin:'3em'}}>
      <CardContent>
