...
class GridList extends Component {
  render() {
    ...
    const title=(seacrhedData.ccy + ' Invoices with value between '+ seacrhedData.ccy+ ' '+ seacrhedData.lowerLimit +' - '+ seacrhedData.upperLimit +' maturing between '+seacrhedData.startDate+' and '+ seacrhedData.endDate)
